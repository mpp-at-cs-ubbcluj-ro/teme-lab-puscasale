...
public class CarsDBRepository implements CarRepository{
    ...
    public void add(Car elem) {
        ...
        Connection con=dbUtils.getConnection();
        try(PreparedStatement perStmt = con.prepareStatement("insert into cars (manufacturer, model, year) values (?,?,?)")){
            perStmt.setString(1,elem.getManufacturer());
            perStmt.setString(2, elem.getModel());
            perStmt.setInt(3,elem.getYear());
            int result = perStmt.executeUpdate();
